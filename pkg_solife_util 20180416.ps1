<#	
.SYNOPSIS
pkg_solife_util creates pl/sql package pkg_solife_util on specified database
	
.DESCRIPTION
pkg_solife_util has 2 procedures, enable_restricted and disable_restriced, to enable/disable restricted mode on specified database
...
.Example pkg_solife_util -oracleSid orasolifedev -mode 'FALSE'		
#>
