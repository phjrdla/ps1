...
column "ENDTIME"       format a19 trunc
column "LOAD"          format 099.999
column "DBBCHNGPTXN"   format 099999
...
select 'BEGINTIME,HOSTCUPSEC,HOSTCUPCT,CUPSEC,DBCPUTIMRATIO,AVGACTSESS,SESSCNT,LOAD,EXECPSEC,RESPTPTXN,SQLRESPT,USERCALLSPSEC,USERTXNPSEC,SHRFREEPCT,ENQRPTXN,DBBCHNGPTXN,REDOPSEC_MB,REDOPTXN_MB,PARSEPTXN' "metrics"
  from dual
/
